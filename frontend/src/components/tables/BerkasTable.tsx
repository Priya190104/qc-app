...
const BerkasTable: React.FC<BerkasTableProps> = React.memo(
  ({
    data,
    isLoading = false,
    onView,
      ...
      <div className="flex items-center gap-1.5">
        {showActions.view && (
          <button
            ...
            aria-label={`Lihat detail berkas ${berkas.nomor}`}
            className="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-md text-xs font-medium text-blue-700 bg-blue-50 hover:bg-blue-100 hover:text-blue-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-1 transition-colors duration-150"
          >
        ...
        {showActions.close && !disableActionsForStatus.includes(berkas.status) && (
          <button
            ...
            aria-label={`Tutup berkas ${berkas.nomor}`}
            className="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-md text-xs font-medium text-orange-700 bg-orange-50 hover:bg-orange-100 hover:text-orange-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-500 focus-visible:ring-offset-1 transition-colors duration-150"
          >
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-gray-50 border-b border-gray-200">
                <th
                  scope="col"
                  className="px-3 py-2.5 text-left text-[11px] font-semibold text-gray-500 uppercase tracking-wide w-[5%]"
                >
                  No.
                </th>
                <th
                  scope="col"
                  className="px-3 py-2.5 text-left text-[11px] font-semibold text-gray-500 uppercase tracking-wide w-[12%]"
                >
                  No. Berkas
                </th>
                <th
                  scope="col"
                  className="px-3 py-2.5 text-left text-[11px] font-semibold text-gray-500 uppercase tracking-wide w-[18%]"
                >
                  Nama Pemohon
                </th>
                <th
                  scope="col"
                  className="px-3 py-2.5 text-left text-[11px] font-semibold text-gray-500 uppercase tracking-wide w-[10%]"
                >
                  Tgl. Masuk
                </th>
                <th
                ...
                <th
                  scope="col"
                  className="px-3 py-2.5 text-left text-[11px] font-semibold text-gray-500 uppercase tracking-wide w-[15%]"
                >
                  Lokasi
                </th>
                <th
