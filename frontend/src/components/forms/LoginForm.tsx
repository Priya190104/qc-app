    ...
    <div className="w-full">
      ...
      <div className="rounded-xl border border-blue-100 bg-gradient-to-br from-blue-50 to-indigo-50 p-4 space-y-2">
        <div className="flex items-center gap-2 mb-1">
          ...
          <p className="text-xs font-semibold text-blue-700">Kredensial Demo</p>
        </div>
        <div className="flex items-center gap-2 bg-white/70 rounded-lg px-3 py-2">
          ...
          <span className="text-xs font-mono font-medium text-gray-800">admin@example.com</span>
        </div>
        <div className="flex items-center gap-2 bg-white/70 rounded-lg px-3 py-2">
          <svg
            className="w-3.5 h-3.5 text-blue-400"
          ...
          <span className="text-xs font-mono font-medium text-gray-800">AdminPassword123!</span>
        </div>
      </div>
    </div>
  );
